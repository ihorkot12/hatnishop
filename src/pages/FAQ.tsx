  ...
  const sections = [
    {
      ...
      items: [
        ...
        { q: 'Скільки коштує доставка?', a: 'Вартість доставки розраховується за тарифами перевізника. При замовленні на суму від 1500 грн доставка у відділення — безкоштовна. А на перше замовлення для зареєстрованих доставка безкоштовна без порогу.' },
        { q: 'Як можна оплатити замовлення?', a: 'Наразі оплата — при отриманні у відділенні перевізника (накладений платіж). Онлайн-оплату картою ми додамо згодом.' }
      ]
    },
    {
